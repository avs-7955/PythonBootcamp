# Mail Merge Project
This Python Program take various names from the text file as an input and makes seperate personalized letter with their names. These letters are stored as seperate text files, ready to be emailed!
