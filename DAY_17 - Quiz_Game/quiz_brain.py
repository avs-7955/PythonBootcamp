...
class QuizBrain:
    ...
    def next_question(self):
        ...
        user_answer = input(
            f"Q.{self.question_number}: {current_ques.text} (True/False): ")
        self.check_answer(user_answer, current_ques.answer)

    def check_answer(self, answer_entered, correct_answer):
        if (answer_entered[0].lower() == correct_answer[0].lower()):
            self.score += 1
